...
int searchFirstSubstringIndex(char*, char*);
int sizeString(char*);
...
int searchFirstSubstringIndex(char* string, char* subString)
{
	int index = -1, midind = 0;
	int lenght = sizeString(string);
	int lenghtSubString = sizeString(subString);
